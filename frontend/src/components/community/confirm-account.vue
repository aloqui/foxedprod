<template>
  <div class="confirm-account">
    <div class="confirm-account-block d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
      <p class="font--semi-bold">Please confirm your email address.</p> 
      <p class="btn mr-auto hover-pointer text-underline" @click="resendCode"><u>Resend Code</u></p>
