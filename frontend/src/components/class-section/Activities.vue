<template>
  <div>
    <activity v-for="activity in activities" @delete-activity="deleteActivity(activity)" @cons="conss(activity)" :authenticatedUser="authenticatedUser"
      :activity="activity" :user="user"></activity>
